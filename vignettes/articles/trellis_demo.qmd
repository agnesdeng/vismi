...
```{r, echo = FALSE}
trellis_vismi(data = newborn, imp_list = imp_newborn, marginal_x = "box+rug", path = "trellis/vismi")
```
...
```{r, echo = FALSE}
trellis_vismi_overimp(obj = obj, stack_y = TRUE, path = "trellis/overimp")
```
...
```{r, echo = FALSE}
trellis_vismi_converge(obj = mice_obj, path = "trellis/converge_mice")
```
...
```{r, echo = FALSE}
trellis_vismi_converge(obj = mixgb_obj, path = "trellis/converge_mixgb")
```
