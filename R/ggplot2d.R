...
ggplot_2num <- function(all_dt,x,y,color_pal,point_size, alpha,marginal_x, marginal_y, plot_title){
...
ggplot_1fac1num <- function(all_dt,x,y,color_pal,point_size, alpha, boxpoints, plot_title){
...
ggplot_2fac <- function(all_dt,x,y,color_pal,alpha, width, plot_title){
  ...
  fig<-ggplot(all_sum, aes(x = .data[[x]], y = prop)) +
    ...
    labs(x=x,y="Proportion",title=plot_title)
