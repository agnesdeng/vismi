# overimp2D_scatter ------------------------------------------------------------
overimp2D_scatter <- function(plot_data, x, y, title, subtitle, alpha, point_size, xlim, ylim, train_color_pal, test_color_pal, gg_style = list()) {
  train_plot <- ggplot(plot_data$train$all_dt, aes(x = .data[[x]], y = .data[[y]], color = Group)) +
    ...
    guides(color = "none")
  train_plot <- .ggplot_overimp_theme(train_plot, showlegend = FALSE, gg_style = gg_style)
...
# overimp2D_box ----------------------------------------------------------------
overimp2D_box <- function(plot_data, x, y, title, subtitle, alpha, point_size, boxpoints, xlim, ylim, train_color_pal, test_color_pal, gg_style = list()) {
...
# overimp2D_bar ----------------------------------------------------------------
overimp2D_bar <- function(plot_data, x, y, title, subtitle, width, alpha, ylim, train_color_pal, test_color_pal, gg_style = list()) {
